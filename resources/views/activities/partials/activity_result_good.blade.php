<div style="background-image:url('{{ asset("images/thumbs-up.gif") }}');background-size:cover;position:relative;background-position-x:116px!important;" class="center-align">
    <div class='right row'>
