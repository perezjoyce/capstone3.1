        ...
        <div class="row no-margin-bottom">
            <div class="col s12">
                ...
                <div class="row hide-on-large-only deep-purple darken-4">
                    <div class="col s6">
                        <h4 class='white-text custom-heading'>Archived Classest</h4>
                    </div>
                                ...
                                <td>
                                    <a class='grey-text text-lighten-1 dropdown-trigger' data-target='class-settings'><i class="material-icons left grey-text text-lighten-1">settings</i>Settings</a>
                                      ...
                                      <ul id='class-settings' class='dropdown-content' style='width:fit-content;'>
                                        ...
                                        <li><a href="#login-modal" class='modal-trigger'>Delete</a></li>
                                      </ul>
    
                                </td>
                                <td>
                                    <a href="teacher_section_details" class='btn orange'><i class="material-icons right">chevron_right</i>View Details</a>
                                </td>
                            </tr>
                            @endif
                            @endforeach
