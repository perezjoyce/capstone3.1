        ...
        <div class="col s12">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <textarea id="new_hint" name="new_hint" class="materialize-textarea"></textarea>
        ...
        <div class="col s12">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <textarea id="new_explanation" name="new_explanation" class="materialize-textarea"></textarea>
        ...
        <div class="col s12">
            <div class="row">
                ...
                <div class="input-field col s12">
                    ...
                    <textarea name="new_answer_1" class="materialize-textarea"></textarea>
                    <label for="new_answer_1">Correct Answer</label>
                </div>
                <div class="input-field col s12">
                    <i class="material-icons prefix grey-text">clear</i>
                    <textarea name="new_answer_2" class="materialize-textarea"></textarea>
                    <label for="new_answer_2">Wrong Answer</label>
                </div>
                <div class="input-field col s12">
                    <i class="material-icons prefix grey-text">clear</i>
                    <textarea name="new_answer_3" class="materialize-textarea"></textarea>
                    <label for="new_answer_3">Wrong Answer</label>
                </div>
                <div class="input-field col s12">
                    <i class="material-icons prefix grey-text">clear</i>
                    <textarea name="new_answer_4" class="materialize-textarea"></textarea>
